...
export function buildAxisSnapLines(
  ...
  const mkLine = (start: number, end: number, neighbor: boolean): SnapLine => {
    ...
    return {
      ...
      textPos: show ? mkTextPos((start + end) / 2) : undefined
    };
  };
